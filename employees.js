...
//CODE HERE
let empOne = new Employee('Nureyev', 'weekday mornings, weekday afternoons')
...
//CODE HERE
let manager = new Manager('Rita', 'weekday mornings, weekday afternoons', ['Cece', 'Shmidt'])
